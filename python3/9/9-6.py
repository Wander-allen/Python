...
class IceCreamstand(Restuarant):
    def __init__(self,reatuarant_name,cuisine_type,flavors,num = 0):
        super().__init__(reatuarant_name,cuisine_type,num)
...
restuarant1 = IceCreamstand('sun','li',['red','bluck'])
restuarant1.describe_restuarant()
restuarant1.display_ice()
